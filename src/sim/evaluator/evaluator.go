...
func evalIntegerInfixExpression(
	...
	case "/":
		ret = leftVal / rightVal
	case "%":
		ret = float64(int64(leftVal) % int64(rightVal))
	case "**":
		ret = math.Pow(float64(leftVal), float64(rightVal))
	case "<":
